      ...
      <div className="container">
        <Link to='/' className="logo-link">
          ...
          <div className="logo-text">
            <span className="text-bold" style={{fontSize: '1.4rem', fontWeight: '700', color: 'black'}}>Cocker</span>
            <span className="second" style={{fontWeight: '700', color: 'black'}}>Spaniel Puppies</span>
          </div>
        </Link>
        {!isMobile && ( // Render links only on larger screens
          <div className="icon-wrapper">
            ...
            <Link className="link" to="/available-puppies/shelter">Available Puppies</Link>

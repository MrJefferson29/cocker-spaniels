...
const Delivery = () => {
  return (
    <DeliverySection>
      ...
      <Paragraph>
        At <Highlight>Adorable Cocker Spaniel Puppies Home</Highlight>, we take pride in offering only the
      ...
      <List>
        <ListItem>The puppy must be at least 9 weeks and 4 days old.</ListItem>

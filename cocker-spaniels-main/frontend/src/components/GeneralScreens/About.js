...
const About = () => {
  return (
    <Container>
      <Header>
        <h1>Cocker Spaniel Excellence</h1>
      ...
      <AdBanner>
        <h2>Want to Meet Our Cocker Spaniels?</h2>
        <p>
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            At Cocker Spaniel Excellence, we are highly selective about the homes we
      ...
      <Section>
        <Content>
          <Title>Why Choose Cocker Spaniel Excellence?</Title>
          <Paragraph>
            Choosing Cocker Spaniel Excellence means you are not only getting a
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            ...
            well-being of every dog we breed. As dedicated Cocker Spaniel lovers, we
      ...
      <Footer>
        <p>&copy; 2024 Cocker Spaniel Excellence. All rights reserved.</p>
      </Footer>
    </Container>
  );
};
